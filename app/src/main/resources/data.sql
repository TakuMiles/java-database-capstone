-- MySQL Data Initialization Script for CMS Database
-- This script inserts sample data into the CMS (Clinic Management System) database
...
-- Note: MongoDB prescriptions data will be inserted separately via MongoDB commands
-- See prescriptions.js file for prescription data insertion