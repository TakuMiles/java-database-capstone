// MongoDB Script for Prescriptions Collection
// Use this script in MongoDB shell or MongoDB Compass

// Switch to prescriptions database
use prescriptions;

// Insert prescription documents
...
print("Inserted " + db.prescriptions.countDocuments() + " prescription documents");

// Display some sample documents
print("\nSample prescription documents:");
db.prescriptions.find().limit(3).pretty();